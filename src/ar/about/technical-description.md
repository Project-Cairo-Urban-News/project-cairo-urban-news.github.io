...
تضمن النظام ملف XML رئيسي يحتوي على معلومات معلومات للجزء العلوي من الملف (TEI Header) لجميع الملفات. وينتج عن تحديث هذا الملف الرئيسي تفعيل إجراء في GitHub يقوم بمزامنة معلومات الجزء العلوي من الملف بين جميع ملفات XML الأخرى، مما يسهل إدارة البيانات المركزية.
...
عندما يتم وضع علامة "cleared" على ملف من قِبل مستيان، يتم تفعيل إجراء آلي في GitHub لإضافة معرفات (ID)
